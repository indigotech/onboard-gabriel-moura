// criar usurario que tera permissoes (receber token)
// mandar mutation de login com esse token no header
// tentar fazer a mutation de createuser atraves desse token de login
